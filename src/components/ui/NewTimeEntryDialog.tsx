...
export const NewTimeEntryDialog: React.FC<NewTimeEntryDialogProps> = ({
  open,
  onOpenChange,
  onSave,
  initialEntry,
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              className="col-span-3"
              step="60"
              data-testid="new-start-time-input"
            />
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
          ...
          {error && (
            <div className="text-red-500 text-sm col-span-4 text-center" data-testid="new-error">
              {error}
            </div>
          )}
        </div>
        <div className="flex justify-end gap-2">
          <Button variant="outline" onClick={() => onOpenChange(false)} data-testid="new-cancel-button">
            Cancel
          </Button>
          <Button onClick={handleSave} data-testid="new-save-button">
            Save
          </Button>
        </div>
      </DialogContent>
